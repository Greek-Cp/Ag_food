...
public class ModelAccount {
    ...
    public ModelAccount(String username, String password, String kedudukan, ModelDetailAccount modelDetailAccount) {
        this.username = username;
        this.password = password;
        this.kedudukan = kedudukan;
        this.modelDetailAccount = modelDetailAccount;
    ...
    public ModelAccount(String username, String password, String kedudukan , String email) {
        this.username = username;
        this.password = password;
        this.kedudukan = kedudukan;
        this.email = email;
